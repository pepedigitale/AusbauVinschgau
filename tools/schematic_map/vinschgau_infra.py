...
def extract_blocks(infra, nodes_df, edges_df):
    """
    ...
    for direction, (origin, destination, is_forward) in DIRECTIONS.items():
        ...
        route = build_route(nodes_df, edges_df, origin, destination)
...
def main():
    ...
    nodes_path = r"C:\Users\LeoC\VSCodes\optimizationVinschgau\AusbauVinschgau\infra_data\nodes.csv"
    edges_path = r"C:\Users\LeoC\VSCodes\optimizationVinschgau\AusbauVinschgau\infra_data\edges.csv"
    output_path = r"C:\Users\LeoC\VSCodes\optimizationVinschgau\AusbauVinschgau\vinschgau_infra1a.html"

    scenario = "1a"

    raw_nodes_df = pd.read_csv(
        nodes_path,
        sep=";",
        encoding="cp1252",
        decimal=","
    ...
    ACTIVE_SCENARIOS = SCENARIOS[scenario]
    ...
    blocks, connections = extract_blocks(infra, nodes_df, edges_df)
